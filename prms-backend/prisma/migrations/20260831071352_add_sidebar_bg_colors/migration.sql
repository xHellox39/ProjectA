...
INSERT INTO "new_website_customizer" ("active_theme", "company_name", "created_at", "dark_accent_color", "dark_body_bg", "dark_footer_bg", "dark_header_bg", "id", "light_accent_color", "light_body_bg", "light_footer_bg", "light_header_bg", "logo_thumb_url", "logo_url", "updated_at") SELECT "active_theme", "company_name", "created_at", "dark_accent_color", "dark_body_bg", "dark_footer_bg", "dark_header_bg", "id", "light_accent_color", "light_body_bg", "light_footer_bg", "light_header_bg", "logo_thumb_url", "logo_url", "updated_at" FROM "website_customizer";
